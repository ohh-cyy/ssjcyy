  ...
  return (
    <section className="section" id="scene">
      <div className="section-head">
        <p className="label">FEATURE 03</p>
        <h2>织锦场景智能适配</h2>
        <p className="desc">
      ...
      <div className="scene-grid">
        <button type="button" className={`upload-zone${ready ? ' active' : ''}`} onClick={onSimulate}>
          <div>
        ...
        <div className="adapt-result">
          ...
          {ready ? (
            ...
            <p style={{ margin: 0, color: 'var(--muted)', fontFamily: 'var(--serif)', lineHeight: 1.8 }}>
